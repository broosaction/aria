...
//require_once(__DIR__ . '/cache/DefaultCache.php');


use Core\Tools\ipinfo\cache\DefaultCache;
use Exception;
...
class IPinfo
{
    ...
    public const CACHE_MAXSIZE = 4096;
    public const CACHE_TTL = 86400; // 24 hours as seconds
    public const COUNTRIES_FILE_DEFAULT = __DIR__ . '/countries.json';
    public const REQUEST_TYPE_GET = 'GET';
    public const STATUS_CODE_QUOTA_EXCEEDED = 429;
    ...
    public function __construct($access_token = null, $settings = [])
    {
        ...
        $this->http_client = new \GuzzleHttp\Client(['http_errors' => false, 'verify' => false]);
