 ...
 * @property \Core\tpl\Support\Dom\HTML5DOMTokenList $classList A collection of the class attributes of the element.
 */
class HTML5DOMElement extends \DOMElement
{
    ...
    public function __set(string $name, $value)
    {
        if ($name === 'innerHTML') {
            ...
            if (!isset(self::$newObjectsCache['html5domdocument'])) {
                self::$newObjectsCache['html5domdocument'] = new \Core\tpl\Support\Dom\HTML5DOMDocument();
            }
    ...
    public function getAttribute($name): string
    {
        ...
        return $value !== '' ? (str_contains($value, 'html5-dom-document-internal-entity') ? $this->updateResult($value) : $value) : '';
    }
    ...
    public function getAttributes(): array
    {
        ...
        foreach ($this->attributes as $attributeName => $attribute) {
            ...
            $attributes[$attributeName] = $value !== '' ? (str_contains($value, 'html5-dom-document-internal-entity') ? $this->updateResult($value) : $value) : '';
        }
        return $attributes;
    }
