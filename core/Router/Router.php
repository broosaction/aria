...
use Core\Router\Route\IControllerRoute;
use Core\Router\Route\IGroupRoute;
use Core\Router\Route\ILoadableRoute;
...
class Router
{
    ...
    public function start( Start $server): ?string
    {
        ...
        if ($this->csrfVerifier !== null) {
            ...
            $this->csrfVerifier->handle($this->server, $this->request);
        }
    ...
    protected function handleException(Exception $e): ?string
    {
        ...
        foreach (array_reverse($this->exceptionHandlers) as $key => $handler) {
            ...
            try {
                ...
                $handler->handleError($this->server, $this->request, $e);
